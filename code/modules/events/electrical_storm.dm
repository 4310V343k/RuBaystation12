...
/datum/event/electrical_storm/tick()
	...
	for(var/obj/machinery/power/apc/T in picked_apcs)
		...
		// Very tiny chance to completely break the APC. Has a check to ensure we don't break critical APCs such as the Engine room, or AIR core. Does not occur on Mundane severity.
