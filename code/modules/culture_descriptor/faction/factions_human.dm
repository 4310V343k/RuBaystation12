...
/decl/cultural_info/faction/scg/army
	name = FACTION_ARMY
	description = "The Sol Central Government Marine Corps is the part SCG's Army. The Marine Corps is responsible for handling any ground conflicts and many peacekeeping missions that the SCG may be engaged in. \
	Marine Corps is much smaller than Fleet, thus less funded. Corps is created to serve with it's 'bigger brother' to assist in planetary missions."
