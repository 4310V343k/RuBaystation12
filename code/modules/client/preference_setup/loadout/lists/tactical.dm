...
/datum/gear/tactical/lap
	...
	allowed_roles = list(/datum/job/officer, /datum/job/warden, /datum/job/detective, /datum/job/expinf, /datum/job/research_guard, /datum/job/sea, /datum/job/captain, /datum/job/hop, /datum/job/rd, /datum/job/cmo, /datum/job/chief_engineer, /datum/job/hos, /datum/job/bridgeofficer, /datum/job/qm, /datum/job/pathfinder)
