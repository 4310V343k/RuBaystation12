...
#define DETONATION_SHUTDOWN_CRITAPC 10		// Critical APC. AIR core and such. Considerably shorter as we don't want to kill the AI with a single blast. Still a nuisance.
