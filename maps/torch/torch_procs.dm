...
/datum/map/proc/give_aa(mob/activator, mob/confirmator)
	...
	priority_announcement.Announce("Обнаружен запрос на выдачу карты экстренного доступа ко всем внутренним системам ГЭК 'Факел'.", "Системы Внутренней Безопасности ЭКСО")
	aa_given = 1
