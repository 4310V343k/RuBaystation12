...
/datum/job/captain/get_description_blurb()
	...
	Вы опытный профессиональный офицер, контролирующий весь корабль и в конечном счете несущий ответственность за все, что происходит на борту. \
...
/datum/job/sea/get_description_blurb()
	...
	Вы опытный член рядового состава, скорее всего, равны по опыту только КО и ИО. Вы знаете регуляции лучше, чем кто-либо другой."
