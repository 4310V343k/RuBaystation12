...
/obj/item/clothing/accessory/solgov/rank/fleet/enlisted
	name = "device (E-1 crewman recruit)"
	desc = "Collar pin denoting the rank of Crewman Recruit."
...
/obj/item/clothing/accessory/solgov/rank/fleet/officer
	...
	desc = "Collar pin denoting the rank of Ensign. Seems a little bigger than its army counterpart."
...
/obj/item/clothing/accessory/solgov/rank/fleet/officer/wo1_monkey
	...
	desc = "Collar pin denoting the mythical rank of Warrant Officer. Too bad it's obviously fake."
	icon_state = "fleetrank_monkey"

/obj/item/clothing/accessory/solgov/rank/fleet/officer/o2
	name = "device (O-2 sub-lieutenant)"
	desc = "Collar pin denoting the rank of Sub-lieutenant. Seems a little bigger than its army counterpart."
	icon_state = "o2_device"
	overlay_state = "device_silver"

/obj/item/clothing/accessory/solgov/rank/fleet/officer/o3
	name = "device (O-3 lieutenant)"
	desc = "Collar pin denoting the rank of Lieutenant. Seems a little bigger than its army counterpart."
	icon_state = "o3_device"
	overlay_state = "device_silver"

/obj/item/clothing/accessory/solgov/rank/fleet/officer/o4
	name = "device (O-4 lieutenant commander)"
	desc = "Collar pin denoting the rank of Lieutenant Commander. Seems a little bigger than its army counterpart."
	icon_state = "o4_device"

/obj/item/clothing/accessory/solgov/rank/fleet/officer/o5
	name = "device (O-5 commander)"
	desc = "Collar pin denoting the rank of Commander. Seems a little bigger than its army counterpart."
	icon_state = "o5_device"
	overlay_state = "device_silver"

/obj/item/clothing/accessory/solgov/rank/fleet/officer/o6
	name = "device(O-6 captain)"
	desc = "Collar pin denoting the rank of Captain. Seems a little bigger than its army counterpart."
...
/obj/item/clothing/accessory/solgov/rank/fleet/fancy
    name = "navy ranks"
    desc = "A blank navy-blue rank patch. For cosplay, perhaps."
    icon_state = "e1_patch"
...
/obj/item/clothing/accessory/solgov/rank/fleet/fancy/enlisted
    ...
    desc = "Patch denoting the rank of Crewman Recruit, meant for service and dress uniforms."

/obj/item/clothing/accessory/solgov/rank/fleet/fancy/enlisted/e2
    name = "patch (E-2 crewman apprentice)
    desc = "Patch denoting the rank of Crewman Apprentice, meant for service and dress uniforms."
    icon_state = "e2_patch"

/obj/item/clothing/accessory/solgov/rank/fleet/fancy/enlisted/e3
    name = "patch (E-3 crewman apprentice)
    desc = "Patch denoting the rank of Crewman, meant for service and dress uniforms."
    icon_state = "e3_patch"

/obj/item/clothing/accessory/solgov/rank/fleet/fancy/enlisted/e4
    name = "patch (E-4 petty officer third class)
    desc = "Patch denoting the rank of Petty Officer Third Class, meant for service and dress uniforms."
    icon_state = "e4_patch"

/obj/item/clothing/accessory/solgov/rank/fleet/fancy/enlisted/e5
    name = "patch (E-5 petty officer second class)
    desc = "Patch denoting the rank of Petty Officer Second Class, meant for service and dress uniforms."
    icon_state = "e5_patch"

/obj/item/clothing/accessory/solgov/rank/fleet/fancy/enlisted/e6
    name = "patch (E-6 petty officer first class)
    desc = "Patch denoting the rank of Petty Officer First Class, meant for service and dress uniforms."
    icon_state = "e6_patch"

/obj/item/clothing/accessory/solgov/rank/fleet/fancy/enlisted/e7
    name = "patch (E-7 chief petty officer)
    desc = "Patch denoting the rank of Chief Petty Officer, meant for service and dress uniforms."
    icon_state = "e7_patch"

/obj/item/clothing/accessory/solgov/rank/fleet/fancy/enlisted/e8
    name = "patch (E-8 senior chief petty officer)
    desc = "Patch denoting the rank of Senior Chief Petty Officer, meant for service and dress uniforms."
    icon_state = "e8_patch"

/obj/item/clothing/accessory/solgov/rank/fleet/fancy/enlisted/e9
    name = "patch (E-9 master chief petty officer)
    desc = "Patch denoting the rank of Master Chief Petty Officer, meant for service and dress uniforms."
    icon_state = "e9_patch"

/obj/item/clothing/accessory/solgov/rank/fleet/fancy/enlisted/e9_alt1
    name = "patch (E-9 command master chief petty officer)
    desc = "Patch denoting the rank of Command Master Chief Petty Officer, meant for service and dress uniforms."
    icon_state = "e9_patch"

/obj/item/clothing/accessory/solgov/rank/fleet/fancy/enlisted/e9_alt2
    name = "patch (E-9 fleet master chief petty officer)
    desc = "Patch denoting the rank of Fleet Master Chief Petty Officer, meant for service and dress uniforms."
    icon_state = "e9_patch"

/obj/item/clothing/accessory/solgov/rank/fleet/fancy/enlisted/e9_alt3
    name = "patch (E-9 force master chief petty officer)
    desc = "Patch denoting the rank of Force Master Chief Petty Officer, meant for service and dress uniforms."
    icon_state = "e9_patch"

/obj/item/clothing/accessory/solgov/rank/fleet/fancy/enlisted/e9_alt4
    name = "patch (E-9 master chief petty officer of the fleet)
    desc = "Patch denoting the rank of Master Chief Petty Officer of the Fleet, meant for service and dress uniforms."
    icon_state = "e9_patch"

/obj/item/clothing/accessory/solgov/rank/fleet/fancy/officer
    name = "ranks (O-1 ensign)"
    desc = "Shoulderboards denoting the rank of Ensign, meant for coats."
