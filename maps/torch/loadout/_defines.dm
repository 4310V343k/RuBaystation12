...
#define EXPLORATION_ROLES list(/datum/job/pathfinder, /datum/job/nt_pilot, /datum/job/explorer, /datum/job/expinf, /datum/job/expeng, /datum/job/synthetic)
